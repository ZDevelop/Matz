...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    private CountDownLatch loginBlocker;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(!cursor.isAfterLast()){
            ...
            database.close();
            dbHelper.close();
            Intent i = new Intent(ctx,MatzMainActivity.class);
            ctx.startActivity(i);
            finish();
        }
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected Boolean doInBackground(Void... params) {
            loginBlocker = new CountDownLatch(1);
            try {
            ...
            JsonObjectRequest loginRequest = new JsonObjectRequest
                    (Request.Method.POST, url, request, new Response.Listener<JSONObject>() {
                        ...
                        public void onResponse(JSONObject response) {
                            try {
                                authFlag = Boolean.parseBoolean(response.getString("auth"));
                            } catch (JSONException e) {
                                e.printStackTrace();
                            }
                            loginBlocker.countDown();
                        }
    ...
    protected void onPostExecute(final Boolean success) {
        ...
        if (success) {
            ...
            values.put(DBHelper.COLUMN_USERNAME,mEmail);
            values.put(DBHelper.COLUMN_PASSWORD,mPassword);
